...
describe('visible title enrichment', () => {
  it('hydrates a missing runtime using the lightweight preview context', async () => {
    ...
    expect(client.getPreviewContext).toHaveBeenCalledWith(
      expect.objectContaining({ id: 10, mediaType: 'movie' }),
    );
    expect(client.getTitleContext).not.toHaveBeenCalled();
  });
});
